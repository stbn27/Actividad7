...
<div class="container mx-auto">
        <form class="row g-3 needs-validation" novalidate method="post" action="./controller/catalogoAgregar.php"> 
                ...
                <div class="col-md-6">
                    ...
                    <input name="id_catalogo" type="number" class="form-control" id="id_catalogo" <?php if($campo_1 != ""){echo "readonly value='$campo_1'";} ?> required>
                    <p class="invalid-feedback ms-2">Campo requerido</p>
                </div>

                <div class="col-md-6">
                    <label for="id_inventario" class="form-label">Inventario</label>
                    <input name="id_inventario" type="number" class="form-control" id="id_inventario" <?php if($campo_2 != ""){echo "value='$campo_2'";} ?> required>
                    <p class="invalid-feedback ms-2">Campo requerido</p>
                </div>

                <div class="col-md-6">
                    <label for="id_proveedor" class="form-label">Proveedor</label>
                    <input name="id_proveedor" type="text" maxlength="3" class="form-control" id="id_proveedor" <?php if($campo_3 != ""){echo "value='$campo_3'";} ?> required>
                    <p class="invalid-feedback ms-2">Campo requerido</p>
                </div>

                <div class="col-md-6">
                    <label for="descripcion_catalogo" class="form-label">Descripcion de catálogo</label>
                    <textarea class="form-control"  rows="3" name="descripcion_catalogo" id="descripcion_catalogo"><?php if($campo_4 != ""){echo $campo_4;} ?></textarea>
                    <!-- <input name="descripcion_catalogo" type="text" maxlength="60" class="form-control" id="descripcion_catalogo" <?php if($campo_4 != ""){echo "value='$campo_4'";} ?> required> -->
                    <p class="invalid-feedback ms-2">Campo requerido</p>
                </div>


                <div class="col-md-6">
                    <label for="foto_catalgo" class="form-label" >Foto catalogo</label>
                    <input name="foto_catalgo" type="text" readonly class="form-control" id="foto_catalgo" <?php if($campo_5 != ""){echo "value='$campo_5'";} ?> disabled>
                    <p class="invalid-feedback ms-2">Campo requerido</p>
                </div>

                <div class="col-md-6">
                    <label for="instrucciones_catalogo" class="form-label" >Intrucciones de catalago.</label>
                    <input name="instrucciones_catalogo" type="text" class="form-control" id="instrucciones_catalogo" <?php if($campo_6 != ""){echo "value='$campo_6'";} ?>>
                    <p class="invalid-feedback ms-2">Campo requerido</p>
                </div>
